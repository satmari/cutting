...
class psoController extends Controller {
	...
	public function index()
	{
		...
		if (Auth::check())
		{
			...
			return view('pso.error',compact('msg'));
		}
		// dd($operator1);
		...
		// dd("Test");
		return view('pso.index', compact('data','location','operators','operator'));
	}
	...
	public function mattress_pso($id) {
		...
		return view('pso.confirm', compact('id'));
	}

	public function mattress_pso_confirm ($id) {
		// dd($id);
