	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading"><b>Other (tubolare) functions for: {{ $g_bin }}</b></div>
				...
				@if ($status == 'TO_SPREAD')
					<a href="{{ url('mattress_to_unload_tub/'.$id) }}" class="btn btn-warning center-block" >Unload mattress</a>
					{{--
					<br>
				...
				@elseif ($status == 'TO_LOAD')
					...
					<a href="{{ url('mattress_to_unload_tub/'.$id) }}" class="btn btn-warning center-block" disabled>Unload mattress</a>
					{{-- 
					<br>
					<a href="{{ url('change_marker_request/'.$id) }}" class="btn btn-info center-block">Change marker request (width)</a>
					<br>
				...
				<hr>
				{!! Form::open(['method'=>'POST', 'url'=>'add_operator_comment_tub']) !!}
