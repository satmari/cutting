	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading"><b>Spread mattress: {{ $mattress }}</b></div>
				<br>
				...
				@if ($status == 'TO_SPREAD')
					...
					@if ($already_partialy_spreaded > 0)
						<a href="{{ url('spread_mattress_partial/'.$id) }}" class="btn btn-warning center-block" disabled><span style="color:black">MATTERSS ALREADY SPREADED PARTIALY, <b>{{ (float)$already_partialy_spreaded }} LAYERS</b></span></a>
					@else 
