    ...
    <div class="row">
        <div class="text-center col-md-6 col-md-offset-3">
            <div class="panel panel-warning">
                <div class="panel-heading"><b><big>New Cartonbox</big></b> table requests from module</div>
                ...
                @if(isset($h))
                    ...
                    <p><a href="{{url('/req_cartonbox_table/')}}" class="btn btn-xs ">Back</a></p>
                @endif
                @if(!isset($h))
                    <p>
                        <a href="{{url('/req_extrabb_table/')}}" class="btn btn-info btn-xs ">ExtraBB requests</a>
                    ...
                    <a href="{{url('/req_cartonbox_table_history/')}}" class="btn btn-danger btn-xs ">History</a>
                @endif
                ...
                -->
                    ...
                    @foreach ($data as $req)
                        <tr>
                            ...
                            @if(!isset($h))
                                <td><a href="{{url('/req_cartonbox_status/'.$req->id)}}" class="btn btn-danger btn-xs ">Change status</a></td>    
                            @endif                   
