    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-danger">
                <div class="panel-heading">1. Izaberite lokaciju <big><b>iz</b></big> koje se brise paspul <i>(jedan od dva nacina)</i>:</div>
                ...
                {!! Form::open(['method'=>'POST', 'url'=>'/paspul_loc_to_del_ki_from_post']) !!}
