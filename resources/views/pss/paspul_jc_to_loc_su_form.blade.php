    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-success">
                <div class="panel-heading">1. Izaberite paspul sa lokacije <big><b>{{ $location_from }}</b></big>:</div>
                ...
                {!! Form::open(['method'=>'POST', 'url'=>'/paspul_loc_to_loc_su_pas_post']) !!}
                        ...
                        <select name="pas_one2" class="chosen">
                            ...
                            @foreach ($pas_keys as $line)
                                <option value="{{ $line->pas_key }}">
                                    {{ $line->skeda }} - {{ $line->paspul_type }} - {{ $line->dye_lot }} - {{ $line->kotur_length }}
                                </option>
                            @endforeach
                        </select>
                    </div>
