    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-success">
                ...
                @if ($location_to == '')
                {!! Form::open(['method'=>'POST', 'url'=>'/paspul_loc_to_loc_su_op_post']) !!}
                ...
                {!! Form::open(['method'=>'POST', 'url'=>'/paspul_loc_to_loc_su_to_post']) !!}
                    
                    {!! Form::hidden('location_from', $location_from) !!}
                    {!! Form::hidden('pas_one', $pas_one) !!}
                    {!! Form::hidden('qty', $qty) !!}
                    {!! Form::hidden('location_to', $location_to) !!}
                    ...
                    <br>
                    {!! Form::submit('Finish', ['class' => 'btn  btn-success center-block']) !!}
