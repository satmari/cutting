		                ...
		                -->
		                    <thead>
		                       <tr>
		                            ...
		                            <th data-sortable="true">Status<!-- <a href="{{ url('update_skeda_status') }}" class="btn btn-primary btn-xs center-bl ock">Update status</a></th> -->
		                    ...
		                    @foreach ($data as $req)
		                        <tr class="ss">
		                            ...
		                            @if ($req->skeda_status == 'Leftover to Check')
	                            		<td>
	                            			<a href="{{ url('declare_no_leftover/'.$req->id) }}" class="btn btn-info btn-xs">Confirm No Leftover</a>
	                            			<a href="{{ url('declare_leftover/'.$req->id) }}" class="btn btn-danger btn-xs">Declare Leftover</a>
	                            		</th>
	                            	@else
	                            		<td>
	                            			<a href="{{ url('declare_no_leftover/'.$req->id) }}" class="btn btn-info btn-xs" disabled>Confirm No Leftover</a>
	                            			<a href="{{ url('declare_leftover/'.$req->id) }}" class="btn btn-danger btn-xs" disabled>Declare Leftover</a>
	                            		</th>
	                            	@endif
