...
class CreatePrintStandardMattressesTable extends Migration {
	...
	public function up()
	{
		Schema::create('print_standard_mattresses', function(Blueprint $table)
		{
			...
			$table->string('pro_pcs_layer_2')->nullable();
			$table->string('multimaterial_2')->nullable();
			...
			$table->string('pro_pcs_layer_3')->nullable();
			$table->string('multimaterial_3')->nullable();
			...
			$table->string('pro_pcs_layer_4')->nullable();
			$table->string('multimaterial_4')->nullable();
			...
			$table->string('pro_pcs_layer_5')->nullable();
			$table->string('multimaterial_5')->nullable();
			...
			$table->string('pro_pcs_layer_6')->nullable();
			$table->string('multimaterial_6')->nullable();
			...
			$table->string('pro_pcs_layer_7')->nullable();
			$table->string('multimaterial_7')->nullable();
			...
			$table->string('pro_pcs_layer_8')->nullable();
			$table->string('multimaterial_8')->nullable();
			...
			$table->string('pro_pcs_layer_9')->nullable();
			$table->string('multimaterial_9')->nullable();
			...
			$table->string('pro_pcs_layer_10')->nullable();
			$table->string('multimaterial_10')->nullable();
			...
			$table->string('pro_pcs_layer_11')->nullable();
			$table->string('multimaterial_11')->nullable();
			...
			$table->string('pro_pcs_layer_12')->nullable();
			$table->string('multimaterial_12')->nullable();
			...
			$table->string('pro_pcs_layer_13')->nullable();
			$table->string('multimaterial_13')->nullable();
			...
			$table->string('pro_pcs_layer_14')->nullable();
			$table->string('multimaterial_14')->nullable();
